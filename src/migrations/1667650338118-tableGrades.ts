...
export class tableGrades1667650338118 implements MigrationInterface {
    name = 'tableGrades1667650338118'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "schoolGrades" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "nameClassId" uuid, "registrationId" uuid, "studentId" uuid, CONSTRAINT "PK_b854161d04295cccfc7425620f4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "grades" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), CONSTRAINT "PK_4740fb6f5df2505a48649f1687b" PRIMARY KEY ("id"))`);
