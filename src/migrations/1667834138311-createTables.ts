...
export class createTables1667834138311 implements MigrationInterface {
    name = 'createTables1667834138311'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "gradesHistory" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "studentId" uuid, "registrationId" uuid, "studentHistoryId" uuid, "gradeId" uuid, CONSTRAINT "REL_f6ce609fc1b22bcc781d3bb99d" UNIQUE ("registrationId"), CONSTRAINT "PK_0621ea3f15e5266f467c8537b3e" PRIMARY KEY ("id"))`);
